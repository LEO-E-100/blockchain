...
class Block(object):
    def __init__(self, dictionary):
        ...
        if not hasattr(self, 'nonce'):
            # we're throwing this in for generation
            self.nonce = 'None'
...
def create_first_block():
    ...
    :return: index zero and arbitrary previous hash
    '''
...
'''
    Now to create the directory and the file system within the directory. 
    This will check if the directory is empty and if so will create the first block. 
